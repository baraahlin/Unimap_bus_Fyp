!function() {
    var t = {
        ...
        2127: function(t, e, n) {
            var r = n(7526)
              ...
              , c = "prototype"
              , l = function(t, e, n) {
                var u, p, d, f, h = t & l.F, v = t & l.G, g = t & l.S, b = t & l.P, y = t & l.B, m = v ? r : g ? r[e] || (r[e] = {}) : (r[e] || {})[c], x = v ? o : o[e] || (o[e] = {}), w = x[c] || (x[c] = {});
                for (u in v && (n = e),
                n)
                    d = ((p = !h && m && void 0 !== m[u]) ? m : n)[u],
                    f = y && p ? a(d, r) : b && "function" == typeof d ? a(Function.call, d) : d,
                    m && s(m, u, d, t & l.U),
                    x[u] != d && i(x, u, f),
                    b && w[u] != d && (w[u] = d)
            };
        ...
        8175: function(t, e, n) {
            ...
            t.exports = function(t, e, n, g, b, y, m) {
                ...
                }, P = e + " Iterator", O = b == h, L = !1, j = t.prototype, T = j[p] || j["@@iterator"] || b && j[b], C = T || k(b), E = b ? O ? k("entries") : C : void 0, q = "Array" == e && j.entries || T;
                if (q && (S = u(q.call(new t))) !== Object.prototype && S.next && (l(S, P, !0),
                r || "function" == typeof S[p] || s(S, p, v)),
                O && T && T.name !== h && (L = !0,
                C = function() {
                    return T.call(this)
                }
        ...
        4719: function(t, e, n) {
            var r = n(4228)
              ...
              , c = "prototype"
              , l = function() {
                var t, e = n(6034)("iframe"), r = i.length;
        ...
        8859: function(t, e, n) {
            ...
            (t.exports = function(t, e, n, a) {
                ...
                t[e] !== n && (c && (i(n, s) || o(n, s, t[e] ? "" + t[e] : l.join(String(e)))),
        ...
        5890: function(t, e, n) {
            for (var r = n(5165), o = n(1311), i = n(8859), s = n(7526), a = n(3341), c = n(906), l = n(7574), u = l("iterator"), p = l("toStringTag"), d = c.Array, f = {
                CSSRuleList: !0,
                ...
                var g, b = h[v], y = f[b], m = s[b], x = m && m.prototype;
                if (x && (x[u] || a(x, u, d),
                x[p] || a(x, p, b),
                c[b] = d,
                y))
        ...
        7999: function(t, e, n) {
            !function(t) {
                "use strict";
                var e, r = /^[a-z]+:/, o = /[-a-z0-9]+(\.[-a-z0-9])*:\d+/i, i = /\/\/(.*?)(?::(.*?))?@/, s = /^win/i, a = /:$/, c = /^\?/, l = /^#/, u = /(.*\/)/, p = /^\/{2,}/, d = /(^\/?)/, f = /'/g, h = /%([ef][0-9a-f])%([89ab][0-9a-f])%([89ab][0-9a-f])/gi, v = /%([cd][0-9a-f])%([89ab][0-9a-f])/gi, g = /%([0-7][0-9a-f])/gi, b = /\+/g, y = /^\w:$/, m = /[^/#?]/, x = "undefined" == typeof window && void 0 !== n.g && !0, w = !x && t.navigator && t.navigator.userAgent && ~t.navigator.userAgent.indexOf("MSIE"), S = x ? t.require : null, k = {
                    protocol: "protocol",
                    host: "hostname",
                    port: "port",
                    path: "pathname",
                ...
                function O() {
                    return x ? e = e || "file://" + (process.platform.match(s) ? "/" : "") + S("fs").realpathSync(".") : "about:srcdoc" === document.location.href ? self.parent.document.location.href : document.location.href
                }
                function L(t) {
                ...
                function T(t) {
                    for (var e = t.split("&"), n = 0, r = e.length; n < r; n++) {
                        ...
                        if (i) {
                            ...
                            void 0 === this[i] ? this[i] = s : (this[i]instanceof Array || (this[i] = [this[i]]),
                            this[i].push(s))
                        }
                    }
                }
                function C(t, e) {
                    !function(t, e, n) {
                        var s, f, h;
                        e = e || O(),
                        x ? s = S("url").parse(e) : (s = document.createElement("a")).href = e;
                        var v, g, b = (g = {
                            path: !0,
                            query: !0,
                            hash: !0
                        },
                        (v = e) && r.test(v) && (g.protocol = !0,
                        g.host = !0,
                        o.test(v) && (g.port = !0),
                        i.test(v) && (g.user = !0,
                        g.pass = !0)),
                        g);
                        for (f in h = e.match(i) || [],
                        k)
                            b[f] ? t[f] = s[k[f]] || "" : t[f] = "";
                        if (t.protocol = t.protocol.replace(a, ""),
                        t.query = t.query.replace(c, ""),
                        t.hash = j(t.hash.replace(l, "")),
                        t.user = j(h[1] || ""),
                        t.pass = j(h[2] || ""),
                        t.port = P[t.protocol] == t.port || 0 == t.port ? "" : t.port,
                        !b.protocol && m.test(e.charAt(0)) && (t.path = e.split("?")[0].split("#")[0]),
                        !b.protocol && n) {
                            ...
                            for (; ".." === E[0]; )
                                L.pop(),
                                E.shift();
                            t.path = ("/" !== e.charAt(0) ? L.join("/") : "") + "/" + E.join("/")
                        }
                ...
                C.prototype.toString = function() {
                    return (this.protocol && this.protocol + "://") + (this.user && L(this.user) + (this.pass && ":" + L(this.pass)) + "@") + (this.host && this.host) + (this.port && ":" + this.port) + (this.path && this.path) + (this.query.toString() && "?" + this.query) + (this.hash && "#" + L(this.hash))
                }
                ,
    ...
    function() {
        ...
        const i = new (e())
          ...
          , d = ()=>{
            document.querySelector(a).querySelectorAll("input[type=radio]").forEach((t=>{
                t.addEventListener("change", (t=>{
                    g(t.target.name, t.target.value),
                    x(t.target.name, t.target.value),
                    "theme" === t.target.name && (window.cssVariables = r(),
        ...
        const S = new MutationObserver((function() {
            document.documentElement && (Object.keys(i.query).length > 0 ? (y(),
